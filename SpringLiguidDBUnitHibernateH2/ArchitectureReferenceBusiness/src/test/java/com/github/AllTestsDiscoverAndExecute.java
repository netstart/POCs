 ...
 */
@RunWith(AllTestsDiscoverAndExecute.AllTestsRunner.class)
public final class AllTestsDiscoverAndExecute {

    private static final File CLASSES_DIR = findClassesDir();

    private AllTestsDiscoverAndExecute() {
        // static only
    }
    ...
    private static File findClassesDir() {
        try {
            String path = AllTestsDiscoverAndExecute.class.getProtectionDomain()
