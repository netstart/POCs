...
public class HttpClientFactory {
    ...
    private void addRetry(HttpClientBuilder builder, HttpClientProperties properties) {
        if (properties.maxRetry > 0) {
            RetryDefault retryDefault = new RetryDefault(properties.maxRetry);
    ...
    private void addServiceUnavailableRetryStrategy(HttpClientBuilder builder, HttpClientProperties properties) {
        int maxRetries = properties.retryServiceUnavailableInterval.maxRetries;
        int retryInterval = properties.retryServiceUnavailableInterval.retryInterval;
        ...
        DefaultServiceUnavailableRetryStrategy retryStrategy = new DefaultServiceUnavailableRetryStrategy(maxRetries, retryInterval);
